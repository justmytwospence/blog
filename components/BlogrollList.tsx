    ...
    <div className="mb-8">
      ...
      <p className="text-lg text-gray-600 dark:text-[#cccccc]">
        ...
        <a
          ...
          className="ml-1 inline-flex items-center align-middle text-gray-700 dark:text-yellow-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
        >
